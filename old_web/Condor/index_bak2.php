...
<div style="border:3px solid red;padding:10px"><b>
	The information shown on these pages refers to a version of Condor older
...
<a href="http://research.iac.es/sieinvens/siepedia/pmwiki.php?n=HOWTOs.Condor">Condor at SIEpedia</a> and 
...
<h4>For the discussion of tricks, announcements about new software
installed, etc., you can subscribe to the 
<a href="<?php ifip_url('http://listas.iac.es/mailman/listinfo/condor', $ip); ?>">Condor mailing
list</a>. If you have any problems with Condor,
please first read the documentation and use the mailing list. If this doesn't
work, then get in touch at 
<script type="text/javascript">condor();</script>
</h4></div>
<Current Condor version: 7.8.7 (installed in February 2013) <br />
Current Condor pool's size: about 600 CPU cores. <br /> -->
*/
?>
<hr />
