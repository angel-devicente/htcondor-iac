# Time-stamp: <2023-03-09 17:22:52 angelv> 
...
+ Submit the job with =condor_submit kerberos.submit=. If you inspect this
  ...
  leave as is for now, except for the actual executable name, which in this
  example is called =simple=, but you will have to adapt it to your particular
  case. 
