# Time-stamp: <2023-10-20 11:07:39 angelv> 
...
=LOADEDMODULES=, and =_LMFILES_=, which are internal Environment Modules
variables) we can see that the only variables modified are =PYTHONPATH= and
=PATH=):
...
of this, see section [[*HTCondor from Python]].
