# Time-stamp: <2023-10-21 09:43:13 angelv> 
...
+ this example illustrates how to use Python to submit jobs, where each job is
  ...
  (for example a compiled code as in the examples in section [[*Examples]]).
  + at the same time we also show how we can use software not installed in
    ...
    section [[*HTCondor and Environment Modules]]. 
...
=job.py [args]=. For a worked-out example of this, see section [[*HTCondor from
Python]]. 
